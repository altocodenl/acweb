...
1. We intend to support our Services until the end of the Internet. That means when it comes to security, privacy, and customer support, we will continue to maintain any legacy Services. Sometimes it becomes technically impossible to continue a feature or we redesign a part of our Services because we think it could be better or we decide to close new signups of a product. We reserve the right at any time to modify or discontinue, temporarily or permanently, any part of our Services with or without notice.
...
4. The names of Company and Services are property of Altocode. This is enforced to protect our users from potential malicious agents that might impersonate Altocode or its Services. All rights reserved. But, you may duplicate, copy, or reuse any portion of the HTML, CSS, JavaScript, or visual design elements without express written permission from Altocode. All code and methodologies are open-source and can be used by the community. If you're going to use Altocode's logo or a Service logo for promotional purposes, you must request permission. Please [email us]({{info@altocode.nl}}) requests to use logos. We reserve the right to rescind this permission if you violate these Terms of Service.
...
In other words: choosing to use our Services does mean you are trusting us. We do our darnedest to be as worthy of that trust through careful management of the business; investments in security, infrastructure, and talent; and in general [giving a damn](https://altocode.nl/blog/our-why). If you choose to use our Services, thank you for trusting us.
