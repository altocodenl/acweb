...
For half a century we had a method: photos go in albums. But then we forgot to switch from organizing physical goods (paper) to digital assets. We kept the old system. 
...
A digital photo album is like a big box. You can have ‘the’ album (or folder) where all the photos go, just like the big box at home with all the paper photos. Or, you have an app where all the digital photo albums are. In that case, the app is the big box. 
...
Simple is natural. The brain organizes memories by association. Association of places, people, context, moments. It only makes sense to <a href="https://altocode.nl/blog/we-remember-by-association" target="_blank">have an organizational method</a> for photos and videos - triggers for memories - similar to the brains’ method. 
